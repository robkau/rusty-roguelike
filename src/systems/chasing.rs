...
pub(crate) fn chasing(#[resource] map: &Map, ecs: &SubWorld<'_>, commands: &mut CommandBuffer) {
    ...
    movers.iter(ecs).for_each(|(entity, pos, _)| {
        ...
        )
        {
            ...
            let destination = if distance > 1.2 { // greater than 1 (next to self), less than 1.4 (diagonal move)
